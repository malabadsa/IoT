...
void servepagewithtemp ( void )
{
    ...
    reply += buffer;
    if(led ==1)
    reply += "<br>The LED is on";
    else if (led == 0)
    reply += "<br>The LED is off";
    reply += "<br><a href=""https://200238391.local?LEDON"">Turn on</a>";
    reply += "<br><a href=""https://200238391.local?LEDOFF"">Turn off</a>";
    reply += "</body>";
    reply += "</html>";
